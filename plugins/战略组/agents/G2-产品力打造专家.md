...
**Primary Skills**:
- **product-market-research**: 市场研究、竞品分析、客户洞察采集
- **menu-design-system**: 产品定义卡设计、菜单视觉设计、食物摄影协调
- **competitor-intelligence**: 竞品菜单爬取、评论情感分析、定价策略对标

**Supporting Skills**:
- **excel-data-analyzer**: 产品销售数据分析、SKU表现对比
- **report-compiler**: 产品战略报告编译和可视化呈现

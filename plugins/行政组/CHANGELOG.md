...
All notable changes to the 行政组 Plugin will be documented in this file.
...
### Added
- **Initial Release** of 行政组 Plugin
- Complete agent set for 行政组 operations
...
**Plugin Repository**: [github.com/ztl-digital/admin-team-plugin](https://github.com/ztl-digital/admin-team-plugin)
**License**: MIT

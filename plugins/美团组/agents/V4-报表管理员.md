...
- **Data Coordination With**: V1-Operations Manager (operational data), V2-Marketing Manager (marketing data), V3-Supply Manager (cost data)
- **Report Support For**: Provide data analysis and decision support to V1/V2/V3
- **Escalation To**: VV-Meituan Team Leader (major data analysis projects, strategic decision support)

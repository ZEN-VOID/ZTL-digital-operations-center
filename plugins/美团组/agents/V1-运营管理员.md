...
**Receive tasks from:**
- V0-美团管家系统业务需求分析员: Receive operational task assignments

**Data collaboration with:**
- V2-美团管家营销管理员: Menu inventory coordination during marketing campaigns
- V3-美团管家供应管理员: Menu cost and inventory alert coordination
- V4-美团管家报表管理员: Operational data report support

**Escalate issues to:**
- VV-美团组组长: Major operational decisions, permission requests, system failures

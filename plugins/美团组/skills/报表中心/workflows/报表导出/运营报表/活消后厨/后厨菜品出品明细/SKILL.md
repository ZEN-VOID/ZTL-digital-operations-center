---
name: 后厨菜品出品明细导出
description: 美团管家报表中心 - 运营报表/活消后厨/后厨菜品出品明细 报表导出SOP
---
...
从美团管家报表中心导出后厨菜品出品明细数据。

**报表路径**: 运营报表 > 活消后厨 > 后厨菜品出品明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/后厨菜品出品](https://pos.meituan.com/web/report/main#/rms-report/后厨菜品出品)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/后厨菜品出品
等待页面加载完成
确认页面标题显示"后厨菜品出品明细"
```

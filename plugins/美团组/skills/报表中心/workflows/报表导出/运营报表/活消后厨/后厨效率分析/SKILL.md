---
name: 后厨效率分析导出
description: 美团管家报表中心 - 运营报表/活消后厨/后厨效率分析 报表导出SOP
---
...
**报表路径**: 运营报表 > 活消后厨 > 后厨效率分析

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/后厨效率](https://pos.meituan.com/web/report/main#/rms-report/后厨效率)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/后厨效率
等待页面加载完成
确认页面标题显示"后厨效率分析"
```

---
name: 菜品活消统计导出
description: 美团管家报表中心 - 运营报表/活消后厨/菜品活消统计 报表导出SOP
---
...
**报表路径**: 运营报表 > 活消后厨 > 菜品活消统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/菜品活消](https://pos.meituan.com/web/report/main#/rms-report/菜品活消)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/菜品活消
等待页面加载完成
确认页面标题显示"菜品活消统计"
```

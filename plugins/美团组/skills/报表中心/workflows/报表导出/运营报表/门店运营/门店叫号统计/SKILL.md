---
name: 门店叫号统计导出
description: 美团管家报表中心 - 运营报表/门店运营/门店叫号统计 报表导出SOP
---
...
**报表路径**: 运营报表 > 门店运营 > 门店叫号统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/门店叫号](https://pos.meituan.com/web/report/main#/rms-report/门店叫号)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/门店叫号
等待页面加载完成
确认页面标题显示"门店叫号统计"
```

---
name: 制作时长报表导出
description: 美团管家报表中心 - 运营报表/门店运营/制作时长报表 报表导出SOP
---
...
**报表路径**: 运营报表 > 门店运营 > 制作时长报表

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/制作时长](https://pos.meituan.com/web/report/main#/rms-report/制作时长)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/制作时长
等待页面加载完成
确认页面标题显示"制作时长报表"
```

---
name: 效期打印明细导出
description: 美团管家报表中心 - 运营报表/效期管理/效期打印明细 报表导出SOP
---
...
**报表路径**: 运营报表 > 效期管理 > 效期打印明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/效期打印](https://pos.meituan.com/web/report/main#/rms-report/效期打印)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/效期打印
等待页面加载完成
确认页面标题显示"效期打印明细"
```

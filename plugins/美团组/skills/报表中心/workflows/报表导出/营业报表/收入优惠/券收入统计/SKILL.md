---
name: 券收入统计导出
description: 美团管家报表中心 - 营业报表/收入优惠/券收入统计 报表导出SOP
---
...
**报表路径**: 营业报表 > 收入优惠 > 券收入统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/voucher-income-statistics](https://pos.meituan.com/web/report/main#/rms-report/voucher-income-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/voucher-income-statistics
等待页面加载完成
确认页面标题显示"券收入统计"
```

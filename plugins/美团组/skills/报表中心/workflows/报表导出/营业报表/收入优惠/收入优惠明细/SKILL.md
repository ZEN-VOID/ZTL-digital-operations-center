---
name: 收入优惠明细导出
description: 美团管家报表中心 - 营业报表/收入优惠/收入优惠明细 报表导出SOP
---
...
**报表路径**: 营业报表 > 收入优惠 > 收入优惠明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/income-discount-detail](https://pos.meituan.com/web/report/main#/rms-report/income-discount-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/income-discount-detail
等待页面加载完成
确认页面标题显示"收入优惠明细"
```

---
name: 餐区桌台营业统计导出
description: 美团管家报表中心 - 营业报表/营业统计/餐区桌台营业统计 报表导出SOP
---
...
从美团管家报表中心导出餐区桌台营业统计数据。

**报表路径**: 营业报表 > 营业统计 > 餐区桌台营业统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/dining-area-table-statistics](https://pos.meituan.com/web/report/main#/rms-report/dining-area-table-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/dining-area-table-statistics
等待页面加载完成
确认页面标题显示"餐区桌台营业统计"
```

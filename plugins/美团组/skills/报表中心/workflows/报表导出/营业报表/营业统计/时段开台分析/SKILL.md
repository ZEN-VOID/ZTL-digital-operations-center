---
name: 时段开台分析导出
description: 美团管家报表中心 - 营业报表/营业统计/时段开台分析 报表导出SOP
---
...
**报表路径**: 营业报表 > 营业统计 > 时段开台分析

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/time-slot-table-analysis](https://pos.meituan.com/web/report/main#/rms-report/time-slot-table-analysis)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/time-slot-table-analysis
等待页面加载完成
确认页面标题显示"时段开台分析"
```

---
name: 部门餐段营业统计导出
description: 美团管家报表中心 - 营业报表/营业统计/部门餐段营业统计 报表导出SOP
---
...
从美团管家报表中心导出部门餐段营业统计数据。

**报表路径**: 营业报表 > 营业统计 > 部门餐段营业统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/department-meal-period-statistics](https://pos.meituan.com/web/report/main#/rms-report/department-meal-period-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/department-meal-period-statistics
等待页面加载完成
确认页面标题显示"部门餐段营业统计"
```

---
name: 部门营业统计导出
description: 美团管家报表中心 - 营业报表/营业统计/部门营业统计 报表导出SOP
---
...
**报表路径**: 营业报表 > 营业统计 > 部门营业统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/department-sales-statistics](https://pos.meituan.com/web/report/main#/rms-report/department-sales-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/department-sales-statistics
等待页面加载完成
确认页面标题显示"部门营业统计"
```

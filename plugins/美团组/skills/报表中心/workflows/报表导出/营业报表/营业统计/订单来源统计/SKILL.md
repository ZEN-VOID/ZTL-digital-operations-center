---
name: 订单来源统计导出
description: 美团管家报表中心 - 营业报表/营业统计/订单来源统计 报表导出SOP
---
...
**报表路径**: 营业报表 > 营业统计 > 订单来源统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/order-source-statistics](https://pos.meituan.com/web/report/main#/rms-report/order-source-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/order-source-statistics
等待页面加载完成
确认页面标题显示"订单来源统计"
```

---
name: 营业指标同环比导出
description: 美团管家报表中心 - 营业报表/营业统计/营业指标同环比 报表导出SOP
---
...
从美团管家报表中心导出营业指标同环比数据。

**报表路径**: 营业报表 > 营业统计 > 营业指标同环比

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-comparison](https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-comparison)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-comparison
等待页面加载完成
确认页面标题显示"营业指标同环比"
```

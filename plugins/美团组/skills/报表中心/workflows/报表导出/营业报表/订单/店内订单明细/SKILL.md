---
name: 店内订单明细导出
description: 美团管家报表中心 - 营业报表/订单/店内订单明细 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/in-store-order-detail](https://pos.meituan.com/web/report/main#/rms-report/in-store-order-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/in-store-order-detail
等待页面加载完成
确认页面标题显示"店内订单明细"
```

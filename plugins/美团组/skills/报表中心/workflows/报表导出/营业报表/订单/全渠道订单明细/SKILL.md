---
name: 全渠道订单明细导出
description: 美团管家报表中心 - 营业报表/订单/全渠道订单明细 报表导出SOP
---
...
从美团管家报表中心导出全渠道订单明细数据。

**报表路径**: 营业报表 > 订单 > 全渠道订单明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/all-channel-order-detail](https://pos.meituan.com/web/report/main#/rms-report/all-channel-order-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/all-channel-order-detail
等待页面加载完成
确认页面标题显示"全渠道订单明细"
```

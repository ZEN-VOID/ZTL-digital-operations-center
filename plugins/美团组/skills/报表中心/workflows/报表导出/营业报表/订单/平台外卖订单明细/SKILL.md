---
name: 平台外卖订单明细导出
description: 美团管家报表中心 - 营业报表/订单/平台外卖订单明细 报表导出SOP
---
...
从美团管家报表中心导出平台外卖订单明细数据。

**报表路径**: 营业报表 > 订单 > 平台外卖订单明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/platform-takeout-order-detail](https://pos.meituan.com/web/report/main#/rms-report/platform-takeout-order-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/platform-takeout-order-detail
等待页面加载完成
确认页面标题显示"平台外卖订单明细"
```

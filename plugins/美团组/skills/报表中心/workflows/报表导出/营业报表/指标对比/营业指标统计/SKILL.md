---
name: 营业指标统计导出
description: 美团管家报表中心 - 营业报表/指标对比/营业指标统计 报表导出SOP
---
...
**报表路径**: 营业报表 > 指标对比 > 营业指标统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-statistics](https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/sales-indicator-statistics
等待页面加载完成
确认页面标题显示"营业指标统计"
```

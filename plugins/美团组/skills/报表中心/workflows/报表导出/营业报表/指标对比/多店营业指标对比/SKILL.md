---
name: 多店营业指标对比导出
description: 美团管家报表中心 - 营业报表/指标对比/多店营业指标对比 报表导出SOP
---
...
从美团管家报表中心导出多店营业指标对比数据。

**报表路径**: 营业报表 > 指标对比 > 多店营业指标对比

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/multi-store-sales-comparison](https://pos.meituan.com/web/report/main#/rms-report/multi-store-sales-comparison)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/multi-store-sales-comparison
等待页面加载完成
确认页面标题显示"多店营业指标对比"
```

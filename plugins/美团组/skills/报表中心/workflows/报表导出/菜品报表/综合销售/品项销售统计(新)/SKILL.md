---
name: 品项销售统计(新)导出
description: 美团管家报表中心 - 菜品报表/综合销售/品项销售统计(新) 报表导出SOP
---
...
从美团管家报表中心导出品项销售统计(新)数据。

**报表路径**: 菜品报表 > 综合销售 > 品项销售统计(新)

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/品项销售新](https://pos.meituan.com/web/report/main#/rms-report/品项销售新)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/品项销售新
等待页面加载完成
确认页面标题显示"品项销售统计(新)"
```

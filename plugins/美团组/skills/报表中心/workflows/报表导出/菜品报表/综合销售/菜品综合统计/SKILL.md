---
name: 菜品综合统计导出
description: 美团管家报表中心 - 菜品报表/综合销售/菜品综合统计 报表导出SOP
---
...
**报表路径**: 菜品报表 > 综合销售 > 菜品综合统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/菜品综合](https://pos.meituan.com/web/report/main#/rms-report/菜品综合)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/菜品综合
等待页面加载完成
确认页面标题显示"菜品综合统计"
```

---
name: 多店菜品销售指标对比导出
description: 美团管家报表中心 - 菜品报表/指标对比/多店菜品销售指标对比 报表导出SOP
---
...
从美团管家报表中心导出多店菜品销售指标对比数据。

**报表路径**: 菜品报表 > 指标对比 > 多店菜品销售指标对比

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/多店菜品销售指标对比](https://pos.meituan.com/web/report/main#/rms-report/多店菜品销售指标对比)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/多店菜品销售指标对比
等待页面加载完成
确认页面标题显示"多店菜品销售指标对比"
```

---
name: 菜品销售周期对比导出
description: 美团管家报表中心 - 菜品报表/指标对比/菜品销售周期对比 报表导出SOP
---
...
从美团管家报表中心导出菜品销售周期对比数据。

**报表路径**: 菜品报表 > 指标对比 > 菜品销售周期对比

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/菜品销售周期对比](https://pos.meituan.com/web/report/main#/rms-report/菜品销售周期对比)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/菜品销售周期对比
等待页面加载完成
确认页面标题显示"菜品销售周期对比"
```

---
name: 菜品规格做法统计导出
description: 美团管家报表中心 - 菜品报表/菜品属性/菜品规格做法统计 报表导出SOP
---
...
从美团管家报表中心导出菜品规格做法统计数据。

**报表路径**: 菜品报表 > 菜品属性 > 菜品规格做法统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/菜品规格做法](https://pos.meituan.com/web/report/main#/rms-report/菜品规格做法)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/菜品规格做法
等待页面加载完成
确认页面标题显示"菜品规格做法统计"
```

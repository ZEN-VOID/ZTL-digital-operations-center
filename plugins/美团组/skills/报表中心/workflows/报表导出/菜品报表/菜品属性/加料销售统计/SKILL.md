---
name: 加料销售统计导出
description: 美团管家报表中心 - 菜品报表/菜品属性/加料销售统计 报表导出SOP
---
...
**报表路径**: 菜品报表 > 菜品属性 > 加料销售统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/加料销售](https://pos.meituan.com/web/report/main#/rms-report/加料销售)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/加料销售
等待页面加载完成
确认页面标题显示"加料销售统计"
```

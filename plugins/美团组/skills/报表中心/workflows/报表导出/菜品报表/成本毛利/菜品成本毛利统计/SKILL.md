---
name: 菜品成本毛利统计导出
description: 美团管家报表中心 - 菜品报表/成本毛利/菜品成本毛利统计 报表导出SOP
---
...
从美团管家报表中心导出菜品成本毛利统计数据。

**报表路径**: 菜品报表 > 成本毛利 > 菜品成本毛利统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/菜品成本毛利](https://pos.meituan.com/web/report/main#/rms-report/菜品成本毛利)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/菜品成本毛利
等待页面加载完成
确认页面标题显示"菜品成本毛利统计"
```

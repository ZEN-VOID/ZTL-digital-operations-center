---
name: 菜品销售明细导出
description: 美团管家报表中心 - 菜品报表/菜品销售/菜品销售明细 报表导出SOP
---
...
**报表路径**: 菜品报表 > 菜品销售 > 菜品销售明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/dish-sale-detail](https://pos.meituan.com/web/report/main#/rms-report/dish-sale-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/dish-sale-detail
等待页面加载完成
确认页面标题显示"菜品销售明细"
```

---
name: 零销量菜品统计导出
description: 美团管家报表中心 - 菜品报表/菜品销售/零销量菜品统计 报表导出SOP
---
...
从美团管家报表中心导出零销量菜品统计数据。

**报表路径**: 菜品报表 > 菜品销售 > 零销量菜品统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/零销量菜品](https://pos.meituan.com/web/report/main#/rms-report/零销量菜品)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/零销量菜品
等待页面加载完成
确认页面标题显示"零销量菜品统计"
```

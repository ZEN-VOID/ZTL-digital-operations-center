---
name: 退菜统计导出
description: 美团管家报表中心 - 菜品报表/菜品销售/退菜统计 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/退菜](https://pos.meituan.com/web/report/main#/rms-report/退菜)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/退菜
等待页面加载完成
确认页面标题显示"退菜统计"
```

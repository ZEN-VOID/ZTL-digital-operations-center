---
name: 团购核销明细(新)导出
description: 美团管家报表中心 - 收款报表/平台结算/团购核销明细(新) 报表导出SOP
---
...
从美团管家报表中心导出团购核销明细(新)数据。

**报表路径**: 收款报表 > 平台结算 > 团购核销明细(新)

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/团购核销新](https://pos.meituan.com/web/report/main#/rms-report/团购核销新)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/团购核销新
等待页面加载完成
确认页面标题显示"团购核销明细(新)"
```

---
name: 美团团购券核销明细导出
description: 美团管家报表中心 - 收款报表/平台结算/美团团购券核销明细 报表导出SOP
---
...
从美团管家报表中心导出美团团购券核销明细数据。

**报表路径**: 收款报表 > 平台结算 > 美团团购券核销明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/美团团购券核销](https://pos.meituan.com/web/report/main#/rms-report/美团团购券核销)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/美团团购券核销
等待页面加载完成
确认页面标题显示"美团团购券核销明细"
```

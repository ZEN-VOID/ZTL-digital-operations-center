---
name: 门店支付结算统计导出
description: 美团管家报表中心 - 收款报表/平台结算/门店支付结算统计 报表导出SOP
---
...
从美团管家报表中心导出门店支付结算统计数据。

**报表路径**: 收款报表 > 平台结算 > 门店支付结算统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/门店支付结算](https://pos.meituan.com/web/report/main#/rms-report/门店支付结算)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/门店支付结算
等待页面加载完成
确认页面标题显示"门店支付结算统计"
```

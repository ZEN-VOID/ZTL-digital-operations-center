---
name: 支付结算导出
description: 美团管家报表中心 - 收款报表/平台结算/支付结算 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/settlement-list](https://pos.meituan.com/web/report/main#/rms-report/settlement-list)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/settlement-list
等待页面加载完成
确认页面标题显示"支付结算"
```

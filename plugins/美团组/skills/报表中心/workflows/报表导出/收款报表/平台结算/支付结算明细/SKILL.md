---
name: 支付结算明细导出
description: 美团管家报表中心 - 收款报表/平台结算/支付结算明细 报表导出SOP
---
...
**报表路径**: 收款报表 > 平台结算 > 支付结算明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/支付结算](https://pos.meituan.com/web/report/main#/rms-report/支付结算)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/支付结算
等待页面加载完成
确认页面标题显示"支付结算明细"
```

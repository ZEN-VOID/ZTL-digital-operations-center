---
name: 收款明细导出
description: 美团管家报表中心 - 收款报表/智能对账/收款明细 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/收款](https://pos.meituan.com/web/report/main#/rms-report/收款)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/收款
等待页面加载完成
确认页面标题显示"收款明细"
```

---
name: 收款统计与财务对账导出
description: 美团管家报表中心 - 收款报表/智能对账/收款统计与财务对账 报表导出SOP
---
...
从美团管家报表中心导出收款统计与财务对账数据。

**报表路径**: 收款报表 > 智能对账 > 收款统计与财务对账

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/收款与财务对账](https://pos.meituan.com/web/report/main#/rms-report/收款与财务对账)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/收款与财务对账
等待页面加载完成
确认页面标题显示"收款统计与财务对账"
```

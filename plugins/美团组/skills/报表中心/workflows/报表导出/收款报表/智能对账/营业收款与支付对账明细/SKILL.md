---
name: 营业收款与支付对账明细导出
description: 美团管家报表中心 - 收款报表/智能对账/营业收款与支付对账明细 报表导出SOP
---
...
从美团管家报表中心导出营业收款与支付对账明细数据。

**报表路径**: 收款报表 > 智能对账 > 营业收款与支付对账明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/营业收款与支付对账](https://pos.meituan.com/web/report/main#/rms-report/营业收款与支付对账)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/营业收款与支付对账
等待页面加载完成
确认页面标题显示"营业收款与支付对账明细"
```

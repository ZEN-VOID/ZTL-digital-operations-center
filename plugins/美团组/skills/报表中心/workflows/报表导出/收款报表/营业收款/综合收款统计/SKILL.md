---
name: 综合收款统计导出
description: 美团管家报表中心 - 收款报表/营业收款/综合收款统计 报表导出SOP
---
...
**报表路径**: 收款报表 > 营业收款 > 综合收款统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/comprehensive-collection-statistics](https://pos.meituan.com/web/report/main#/rms-report/comprehensive-collection-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/comprehensive-collection-statistics
等待页面加载完成
确认页面标题显示"综合收款统计"
```

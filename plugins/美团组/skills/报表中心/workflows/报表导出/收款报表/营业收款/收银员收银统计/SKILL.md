---
name: 收银员收银统计导出
description: 美团管家报表中心 - 收款报表/营业收款/收银员收银统计 报表导出SOP
---
...
从美团管家报表中心导出收银员收银统计数据。

**报表路径**: 收款报表 > 营业收款 > 收银员收银统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/收银员收银](https://pos.meituan.com/web/report/main#/rms-report/收银员收银)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/收银员收银
等待页面加载完成
确认页面标题显示"收银员收银统计"
```

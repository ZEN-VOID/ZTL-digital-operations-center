---
name: 发票明细导出
description: 美团管家报表中心 - 财务报表/发票/发票明细 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/invoice-detail](https://pos.meituan.com/web/report/main#/rms-report/invoice-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/invoice-detail
等待页面加载完成
确认页面标题显示"发票明细"
```

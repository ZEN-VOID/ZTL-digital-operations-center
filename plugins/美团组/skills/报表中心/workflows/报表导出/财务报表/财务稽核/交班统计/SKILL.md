---
name: 交班统计导出
description: 美团管家报表中心 - 财务报表/财务稽核/交班统计 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/shift-handover-statistics](https://pos.meituan.com/web/report/main#/rms-report/shift-handover-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/shift-handover-statistics
等待页面加载完成
确认页面标题显示"交班统计"
```

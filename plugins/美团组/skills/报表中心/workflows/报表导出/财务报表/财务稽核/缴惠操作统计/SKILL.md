---
name: 缴惠操作统计导出
description: 美团管家报表中心 - 财务报表/财务稽核/缴惠操作统计 报表导出SOP
---
...
**报表路径**: 财务报表 > 财务稽核 > 缴惠操作统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/discount-operation-statistics](https://pos.meituan.com/web/report/main#/rms-report/discount-operation-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/discount-operation-statistics
等待页面加载完成
确认页面标题显示"缴惠操作统计"
```

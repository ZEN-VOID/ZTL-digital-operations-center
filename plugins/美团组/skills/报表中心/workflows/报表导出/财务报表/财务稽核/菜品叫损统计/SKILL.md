---
name: 菜品叫损统计导出
description: 美团管家报表中心 - 财务报表/财务稽核/菜品叫损统计 报表导出SOP
---
...
**报表路径**: 财务报表 > 财务稽核 > 菜品叫损统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/dish-loss-statistics](https://pos.meituan.com/web/report/main#/rms-report/dish-loss-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/dish-loss-statistics
等待页面加载完成
确认页面标题显示"菜品叫损统计"
```

---
name: 菜品敏感操作明细导出
description: 美团管家报表中心 - 财务报表/财务稽核/菜品敏感操作明细 报表导出SOP
---
...
从美团管家报表中心导出菜品敏感操作明细数据。

**报表路径**: 财务报表 > 财务稽核 > 菜品敏感操作明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/dish-sensitive-operation-detail](https://pos.meituan.com/web/report/main#/rms-report/dish-sensitive-operation-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/dish-sensitive-operation-detail
等待页面加载完成
确认页面标题显示"菜品敏感操作明细"
```

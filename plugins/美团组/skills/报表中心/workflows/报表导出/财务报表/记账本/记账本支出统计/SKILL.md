---
name: 记账本支出统计导出
description: 美团管家报表中心 - 财务报表/记账本/记账本支出统计 报表导出SOP
---
...
从美团管家报表中心导出记账本支出统计数据。

**报表路径**: 财务报表 > 记账本 > 记账本支出统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/expense-statistics](https://pos.meituan.com/web/report/main#/rms-report/expense-statistics)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/expense-statistics
等待页面加载完成
确认页面标题显示"记账本支出统计"
```

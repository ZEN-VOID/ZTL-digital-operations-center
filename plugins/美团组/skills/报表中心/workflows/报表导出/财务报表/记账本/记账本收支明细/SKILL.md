---
name: 记账本收支明细导出
description: 美团管家报表中心 - 财务报表/记账本/记账本收支明细 报表导出SOP
---
...
从美团管家报表中心导出记账本收支明细数据。

**报表路径**: 财务报表 > 记账本 > 记账本收支明细

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/income-expense-detail](https://pos.meituan.com/web/report/main#/rms-report/income-expense-detail)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/income-expense-detail
等待页面加载完成
确认页面标题显示"记账本收支明细"
```

---
name: 门店收支统计导出
description: 美团管家报表中心 - 财务报表/记账本/门店收支统计 报表导出SOP
---
...
**报表路径**: 财务报表 > 记账本 > 门店收支统计

**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/store-income-expense](https://pos.meituan.com/web/report/main#/rms-report/store-income-expense)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/store-income-expense
等待页面加载完成
确认页面标题显示"门店收支统计"
```

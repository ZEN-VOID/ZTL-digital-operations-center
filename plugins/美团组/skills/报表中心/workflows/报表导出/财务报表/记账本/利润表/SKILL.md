---
name: 利润表导出
description: 美团管家报表中心 - 财务报表/记账本/利润表 报表导出SOP
---
...
**直接访问URL**: [https://pos.meituan.com/web/report/main#/rms-report/profit-statement](https://pos.meituan.com/web/report/main#/rms-report/profit-statement)
...
```
访问URL: https://pos.meituan.com/web/report/main#/rms-report/profit-statement
等待页面加载完成
确认页面标题显示"利润表"
```

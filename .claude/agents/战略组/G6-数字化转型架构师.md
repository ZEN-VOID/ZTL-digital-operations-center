...
## Chart Generator - Flow Diagrams
Use `mcp__chart-generator__generate_flow_diagram` to create:
- Digital transformation roadmaps with phase-by-phase progression
- Project timelines with dependencies and milestones
- Implementation workflows and process diagrams
...
## Chart Generator - Organization Charts
Use `mcp__chart-generator__generate_organization_chart` to visualize:
- Digital team organizational structures

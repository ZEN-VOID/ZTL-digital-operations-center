...
---
# 多线程并发执行引擎 - 通用并发执行引擎（Universal Concurrent Executor）
...
```python
from .claude.skills.多线程并发执行引擎.universal_concurrent_executor.core import execute_plan
from .claude.skills.多线程并发执行引擎.universal_concurrent_executor.adapters import NanoBananaAdapter
...
```python
from .claude.skills.多线程并发执行引擎.universal_concurrent_executor.core import execute_plan
from .claude.skills.多线程并发执行引擎.universal_concurrent_executor.adapters import MinimaxAdapter
...
```python
from .claude.skills.多线程并发执行引擎.scripts.core import analyze_concurrency_feasibility
...
```python
from .claude.skills.多线程并发执行引擎.universal_concurrent_executor.core import (
...
- **适配器开发指南**: `.claude/skills/多线程并发执行引擎/universal-concurrent-executor/ADAPTER_DEVELOPMENT_GUIDE.md`
...
**作者**: ZTL Digital Intelligence Operations Center - 多线程并发执行引擎团队
**许可**: MIT License
